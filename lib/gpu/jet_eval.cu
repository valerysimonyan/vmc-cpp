...
void eval_jet_prepare(DeviceState& ds, cublasHandle_t handle, int B, cudaStream_t stream, bool stash) {
    ...
    { VMC_PROF("getri", stream); batched_inverse(handle, B*K, ds.M_batch.d, ds.lu_ptrs.d, ds.inv_ptrs.d, ds.lu_piv.d, ds.inv_info.d, ds.Minv_batch.d, stream); }
}
